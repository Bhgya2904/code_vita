...
import { 
  FolderKanban, Users, Clock, CheckCircle2, AlertTriangle, Plus
} from 'lucide-react';
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {projects.slice(0, 3).map((project) => (
              <ProjectCard key={project.id} project={project} onClick={() => console.log('View project:', project.id)} />
            ))}
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {teamLeads.map((lead) => {
              ...
              return (
                <div key={lead.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 bg-gray-50 rounded-lg gap-4">
